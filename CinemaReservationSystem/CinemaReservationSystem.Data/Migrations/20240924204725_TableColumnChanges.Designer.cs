...
namespace CinemaReservationSystem.Data.Migrations
{
    ...
    [Migration("20240924204725_TableColumnChanges")]
    partial class TableColumnChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaReservationSystem.Core.Entities.Theater", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaReservationSystem.Core.Entities.ShowTime", b =>
                {
                    ...
                    b.HasOne("CinemaReservationSystem.Core.Entities.Theater", "Theater")
                        .WithMany("ShowTimes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CinemaReservationSystem.Core.Entities.AppUser", null)
                        .WithMany()
